...
public class RepositoryImpl implements Repository {
  ...
  @Inject public RepositoryImpl(RestApi restApi) {
    this.restApi = restApi;
  }

  @Override public Observable<Response> getFuli(int pageSize, int page) {
    return getResponse(RestApi.TYPE_FULI, pageSize, page);
  }

  @Override public Observable<Response> getAndroid(int pageSize, int page) {
    return getResponse(RestApi.TYPE_ANDROID, pageSize, page);
  }

  @Override public Observable<Response> getIOS(int pageSize, int page) {
  ...
  private Observable<Response> getResponse(String type, int pageSize, int page) {
    return restApi.getGank(type, pageSize, page)
