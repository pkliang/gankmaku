 ...
 */
public abstract class BaseGanhuoFragment
    extends BaseDanmakuFragment<SwipeRefreshLayout, Response, GanhuoView, GanhuoPresenter>
  ...
  @DebugLog @Override public void OnPageChanged(int oldPos, int newPos) {
