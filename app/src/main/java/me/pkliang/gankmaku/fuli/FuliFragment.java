 ...
 */
public class FuliFragment extends BaseDanmakuFragment<SwipeRefreshLayout, Response, FuliView, FuliPresenter>
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        emptyRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.HORIZONTAL, false));
        emptyView.setText(getText(R.string.no_data));

        emptyRecyclerView.addOnScrollListener(
        ...
        RecyclerViewPreloader<Entry> preloader = new RecyclerViewPreloader<>(Glide.with(getActivity()), adapter,
    ...
    @Override
    public FuliPresenter createPresenter() {
    ...
    @DebugLog
    @Override
    public void onPaletteReady(int i, Palette palette) {
