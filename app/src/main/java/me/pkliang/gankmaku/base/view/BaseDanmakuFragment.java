 ...
 */
public abstract class BaseDanmakuFragment<CV extends SwipeRefreshLayout, M , V extends PaginationView<M>, P extends PaginationRxPresenter<V, M>> extends BaseSwipeToRefreshLoadMoreFragment<CV, M, V, P> {
    ...
    protected void initDanmaku(DanmakuSurfaceView danmakuSurfaceView, BaseDanmakuParser parser) {
        if (danmakuSurfaceView != null) {
            ...
            danmakuSurfaceView.setCallback(
    ...
    protected void testDanMu(DanmakuSurfaceView danmakuSurfaceView, BaseDanmakuParser mParser, String string, int textColor, int borderColor) {
