 ...
 */
public abstract class BaseSwipeToRefreshLoadMoreFragment<CV extends SwipeRefreshLayout, M , V extends PaginationView<M>, P extends PaginationRxPresenter<V, M>> extends MvpLceViewStateFragment<CV, M, V, P>
    ...
    public void showContent() {
        super.showContent();
        if (emptyRecyclerView.getEmptyView() == null)
    ...
    @Override
    public void setMoreData(M data, boolean hasMore) {
