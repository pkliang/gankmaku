 ...
 */
public abstract class BaseAdapter<V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V> implements IDataAdapter<Response> {
    ...
    @Override
    public void notifyDataChanged(Response response, boolean isRefresh) {
        if (isRefresh)
            mResponse.getResults().clear();
